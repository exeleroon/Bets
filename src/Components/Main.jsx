    ...
    async function onConnect() {
        try {
            const provider = new WalletConnectProvider({
                infuraId: '0ca6dbeae7224218bbd2fc8df4a32953'
            })
                ...
                <div className='bet-block' id='bet'>
                            ...
                            !account ? (
                                <div className={toggleModal ? 'overlay--active overlay' : 'overlay'}>
                                    <div className='popup connect-popup'>
                                        <span onClick={() => setToggleModal(!toggleModal)} className='cross close-popup'></span>
                                        <div className='heading'>Connect Wallet</div>
                                        <div className='connect-popup-wallets'>
                                            <div onClick={() => onConnect()} className='wallet-card-wrapper'>
                                            ...
                                            <div className='wallet-card-wrapper' onClick={() => activateBrowserWallet()}>
                                ...
                                <div className={toggleModal ? 'overlay--active overlay' : 'overlay'}>
                                    <div className='popup connect-popup'>
                                        ...
                                        <form onSubmit={handleSubmit} className='form-wrapper' noValidate=''>
                                            <div className='form-row'>
                                                ...
                                                <input
                                                    ...
                                                    id='betVal'
                                                />
                                                {touched && fieldErrors && <p className='errorField'>{fieldErrors}</p>}
                                            </div>
                                        ...
                                        <div className='popup-bet-your-bet'>Your bet: {tokensInput}</div>
                                    </div>
                                </div>
                            )
                        ) : (
                    ...
                    <div style={{ display: 'none' }}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='form-row'>
                                <label>Your bet</label>
                                <input name='betValue' onChange={handleChange} value={tokensInput} id='betVal' type='number' />
                            </div>
                            <button type='submit' className='button'>
                                BET
                            </button>
